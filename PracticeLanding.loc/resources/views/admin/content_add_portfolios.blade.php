<div class="wrapper container-fluid">
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			{!! Form::text('name',old('name'),['class' => 'form-control','placeholder'=>'Введите название ячейки портфолио'])!!}
		</div>
	...
	<div class="form-group">
	     ...
	     <div class="col-xs-8">
		 	{!! Form::text('filter', old('filter'), ['class' => 'form-control','placeholder'=>'Введите фильтр в портфолио']) !!}
		 </div>
    </div>
